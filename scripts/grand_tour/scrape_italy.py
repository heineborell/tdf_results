...
driver.get("https://www.procyclingstats.com/race/giro-d-italia/2024/stage-11")
...
for year in year_list:
    print(year)
    driver.get("https://www.procyclingstats.com/race/giro-d-italia/" + year + "/")
    drop_list = driver.find_elements(By.CLASS_NAME, "pageSelectNav ")
    time.sleep(2)
    if len(drop_list) == 2:
    ...
    skip_stages = [
        ...
        "Stage 16 | Tarbes - Pau",
        "Stage 19 | Ponte di Legno - Val Martello/Martelital",
    ]
    ...
    for i, stage in enumerate(stage_list):
        ...
        if ttt_val == 0 and not all([el != ",," for el in time_lst]):
            ...
            df.to_csv("../../data/pro_cycling_db/pro_tdf/protdf_giro.csv")
            info_df.to_csv("../../data/pro_cycling_db/pro_tdf/info/infodf_giro.csv")
        else:
